...
class MarketSnapshot:
    ...
    def expiries(self):
        ...
        return sorted(self.option_chain["EXPIRY_DATE"].drop_duplicates().tolist())
    ...
    def calls(self):
        ...
        return self.option_chain[self.option_chain["OPTION_TYPE"] == "CE"]

    def puts(self):

        return self.option_chain[self.option_chain["OPTION_TYPE"] == "PE"]

    def expiry(self, expiry_date):

        return self.option_chain[self.option_chain["EXPIRY_DATE"] == expiry_date]
