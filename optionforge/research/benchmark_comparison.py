...
class BenchmarkComparison:
    ...
    def __post_init__(self) -> None:
        ...
        if self.tracking_error < 0:
            ...
            raise ValueError("tracking_error cannot be negative.")
    ...
    def __str__(self):
        ...
        return f"BenchmarkComparison(" f"alpha={self.alpha:.2f})"

    def __repr__(self):

        return f"BenchmarkComparison(" f"benchmark='{self.benchmark_name}')"
