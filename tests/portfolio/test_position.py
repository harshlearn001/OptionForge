...
def test_market_value():
    ...
    assert position().market_value == 27500.0
...
def test_total_pnl():
    ...
    assert position().total_pnl == 3000.0


def test_return_percentage():

    assert position().return_percentage == 12.0
