...
from optionforge.intelligence.rules.risk_intelligence_rule import (
    RiskIntelligenceRule,
)
...
def test_dealer_only():
    ...
    assert intelligence.id == "institutional_risk"
